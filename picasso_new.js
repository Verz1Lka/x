...
function picassoCanvas(roundNumber, seed, params) {
    ...
    class Prng {
        ...
        getNext() {
            ...
            console.log(`Next random value: ${this.currentNumber}`);
    ...
    function adaptRandomNumberToContext(randomNumber, maxBound, floatAllowed) {
        ...
        const result = Math.floor(randomNumber * maxBound);
        console.log(`Adapted random value: ${result}`);
        return result;
    }
    ...
    try {
        ...
        const r = {
            data: canvasElt.toDataURL(),
            hash: x64hash128(canvasElt.toDataURL(), seed)
        }
        return r
    } catch (e) {}
}